...
public class PathTest {
    ...
    public void multiplePathSegmentStringPathTest() {
        ...
        final String stringPath = path.getPath();
        assertThat(stringPath, equalTo("EMIR1/EMIR2"));
        final List<String> pathSegments = path.getPathSegments();
        assertThat(pathSegments, hasSize(2));
        assertThat(pathSegments, containsInAnyOrder("EMIR1", "EMIR2"));
    }
    ...
    public void whenUsingListGetPathWithNumbers_returnsPathWithNumbers() {
        ...
        assertThat(pathWithValues, equalTo("EMIR1/4/EMIR2/4.0"));
    }
    ...
    public void whenUsingStringGetPathWithStrings_returnsPathWithStrings() {
        ...
        assertThat(pathWithValues, equalTo("EMIR1/A/EMIR2/B"));
    }
    ...
    public void getPathWithStringWhenShouldBeNumeric_throwsException() {
        ...
        try {
            ...
            assertThat(illegalArgumentException, hasMessage(Matchers.equalTo("Expecting numeric value, cannot insert EMIR into '#'.")));
        }
    }
    ...
    public void passingMoreValuesThanBindingsThrowsException() {
        ...
        try {
            ...
            assertThat(illegalArgumentException, hasMessage(Matchers.equalTo("Incoming values does not match number of bindings.")));
        }
    }
    ...
    public void mathcingUris(){
        ...
        assertFalse(path.matches(uri1));
        assertFalse(path.matches(uri2));
